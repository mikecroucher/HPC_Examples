...
@#$#@#$#@
<experiments>
  <experiment name="ParallelExperiment1" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    ...
    <steppedValueSet variable="initial-number-sheep" first="10" step="5" last="250"/>
    <enumeratedValueSet variable="show-energy?">
      <value value="false"/>
    </enumeratedValueSet>
    <steppedValueSet variable="grass-regrowth-time" first="0" step="25" last="100"/>
